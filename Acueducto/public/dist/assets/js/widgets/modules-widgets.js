...
var options1 = {
  ...
  series: [{
      name: 'Suscriptores',
      data: [147, 90, 246, 123, 246, 147, 246, 90, 147, 246, 90, 147]
  }],
...
var options = {
    ...
    colors: ['#2196f3', '#e2a03f', '#8738a7', '#6d17cb'],
    dataLabels: {
      enabled: false
    },
    legend: {
    ...
    series: [985, 737, 270, 123],
    labels: ['Pereira', 'Dosquebradas', 'Santa Rosa', 'La Virginia'],
    responsive: [{
        breakpoint: 1599,
        options: {
            chart: {
